...
public class SharedPref {
    ...
    public ArrayList<ContactVO> getListObject(String key, ContactVO contactVO) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ContactVO> objects = new ArrayList<ContactVO>();

        for (String jObjString : objStrings) {
            ContactVO value = gson.fromJson(jObjString, ContactVO.class);
            objects.add(value);
        }
        return objects;
    }
    ...
    public void putListObject(String key, ArrayList<ContactVO> objArray) {
        checkForNullKey(key);
        Gson gson = new Gson();
